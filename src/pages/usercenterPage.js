     ...
     return (
       <View style={styles.container} >
           ...
           <View style={styles.statusMenu}>
            {this.userStatusMenuRender(require('../assets/images/ic_notpay.png'),'代付款',()=>this.props.navigation.navigate('NoPayOrders'))}
            {this.userStatusMenuRender(require('../assets/images/ic_pay.png'),'已付款',()=>this.props.navigation.navigate('PayOrders'))}
            {this.userStatusMenuRender(require('../assets/images/ic_not_evalute.png'),'待评价',()=>this.props.navigation.navigate('OrderBeComment'))}
            {this.userStatusMenuRender(require('../assets/images/ic_invalid.png'),'已结束',()=>this.props.navigation.navigate('EndOrders'))}
           </View>
           <View style={{marginTop:10}}>
           <List>
              {ViewUtils.itemhasArr(require('../assets/images/ic_account.png'),'消费流水',()=>this.props.navigation.navigate('ConsumeRecords'),22,19)}
              {/* ViewUtils.itemhasArr(require('../assets/images/ic_join.png'),'加入我们',()=>this.props.navigation.navigate('LandlordMenu'),23,22) */}
              {ViewUtils.itemhasArr(require('../assets/images/zkyx.png'),'我的意向',()=>this.props.navigation.navigate('CustomerIntent'),22,21)}
              {ViewUtils.itemhasArr(require('../assets/images/fdyx.png'),'房东意向',()=>this.props.navigation.navigate('LandlordInternt'),21,23)}
